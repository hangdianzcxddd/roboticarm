...
from robot_control.linux.config.robot_config import MoveMode, RobotConfig, ROBOT_CONFIG
from robot_control.linux.arm.safety import SafetyChecker, SafetyError
from robot_control.shared.geometry import EndPose, SDK_DEG_FACTOR
...
class PiperSdkLike(Protocol):
    ...
    def GetArmGripperCtrl(self) -> Any: ...
...
class PiperController:
    ...
    def get_gripper_command(self) -> Any:
        return self.sdk.GetArmGripperCtrl()
